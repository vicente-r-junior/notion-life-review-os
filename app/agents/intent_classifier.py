...
_SYSTEM = (
    ...
    "IMPORTANT: 'update/set/fill a field on existing records' is log, NOT add_column. "
    "add_column is only for structural changes (adding a new column definition), not for filling data.\n"
